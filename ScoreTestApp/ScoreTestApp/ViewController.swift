...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var studentNumberSlider: UISlider!
    ...
    @IBAction func studentNumberSlide(_ sender: Any) {
        //let n_student:Int = Int(studentNumberSlider.value)
        //nStudentOHE(nStudent: n_student)
    }
    ...
    @IBAction func buttonPressed(_ sender: Any) {
        ...
        nStudentOHE(nStudent: Int(studentNumberSlider.value))
        ...
        var result = Array(String(model_output.posttest))
        print(result)
        
        let final_result = result[0]
        
        print(final_result)
        //nextVC.resultScore.text =
        
        //nextVC.resultScore.text = String(Int(model_output.posttest))
        
        //nextVC!.resultScore.text = String(model_output.posttest)
